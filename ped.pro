...
unrealRootPath=/media/swarm/b0a89838-e187-400f-a659-fbc018880184/UnrealEngine
pedRootPath=/home/swarm/Documents/Unreal Projects/ped

gameProjectFile=/home/swarm/Documents/Unreal Projects/ped/ped.uproject
...
include(pedSource.pri)
include(pedHeader.pri)
include(pedConfig.pri)
include(pedIncludes.pri)
include(pedDefines.pri)

ped-Linux-Debug.commands = $$build ped Linux Debug  -project="\"$$gameProjectFile\"" $$args
ped-Linux-DebugGame.commands = $$build ped Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ped-Linux-Shipping.commands = $$build ped Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ped-Linux-Test.commands = $$build ped Linux Test  -project="\"$$gameProjectFile\"" $$args
ped.commands = $$build ped Linux Development  -project="\"$$gameProjectFile\"" $$args

pedEditor-Linux-Debug.commands = $$build pedEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
pedEditor-Linux-DebugGame.commands = $$build pedEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
pedEditor-Linux-Shipping.commands = $$build pedEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
pedEditor-Linux-Test.commands = $$build pedEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
pedEditor.commands = $$build pedEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	ped-Linux-Test \
	ped \
	pedEditor-Linux-Debug \
	pedEditor-Linux-DebugGame \
	pedEditor-Linux-Shipping \
	pedEditor-Linux-Test \
	pedEditor \
