...
ped-Linux-Debug:
	 $(PROJECTBUILD) ped Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ped-Linux-DebugGame:
	 $(PROJECTBUILD) ped Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ped-Linux-Shipping:
	 $(PROJECTBUILD) ped Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ped-Linux-Test:
	 $(PROJECTBUILD) ped Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ped:
	 $(PROJECTBUILD) ped Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

pedEditor-Linux-Debug:
	 $(PROJECTBUILD) pedEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

pedEditor-Linux-DebugGame:
	 $(PROJECTBUILD) pedEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

pedEditor-Linux-Shipping:
	 $(PROJECTBUILD) pedEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

pedEditor-Linux-Test:
	 $(PROJECTBUILD) pedEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

pedEditor:
	 $(PROJECTBUILD) pedEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
